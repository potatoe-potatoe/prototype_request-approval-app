...
export const mockRequests: ApprovalRequest[] = [
  {
    ...
    funds: [
      { name: 'furniture', amount: 234 },
      { name: 'office', amount: 512 },
    ],
  ...
  },
  {
    ...
    reviewTypes: [ReviewType.Proposal],
    funds: [
      { name: 'facilities', amount: 678 },
      { name: 'contract', amount: 1000 },
    ],
  ...
  },
  {
    ...
    reviewTypes: [ReviewType.Proposal],
    funds: [
      { name: 'supplies', amount: 445 },
      { name: 'printing', amount: 187 },
    ],
    transactionType: 'Purchase Order',
    amount: 18500,
  },
  {
    ...
    funds: [
      { name: 'events', amount: 356 },
      { name: 'catering', amount: 123 },
    ],
    transactionType: 'Service Contract',
    amount: 280000,
  },
  {
    ...
    reviewTypes: [ReviewType.Proposal],
    funds: [
      { name: 'security', amount: 654 },
      { name: 'it', amount: 1243 },
      { name: 'infrastructure', amount: 923 },
    ],
    transactionType: 'Purchase Order',
    amount: 95000,
  },
  {
    ...
    reviewTypes: [ReviewType.Proposal],
    funds: [
      { name: 'health', amount: 312 },
      { name: 'safety', amount: 267 },
      { name: 'supplies', amount: 445 },
    ],
    transactionType: 'Purchase Order',
    amount: 12000,
  ...
  },
  {
    ...
    reviewTypes: [ReviewType.Others],
    funds: [
      { name: 'compliance', amount: 567 },
      { name: 'records', amount: 423 },
    ],
    transactionType: 'Service Contract',
    amount: 32000,
  },
